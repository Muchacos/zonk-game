...
MSG_REGISTRY = {
    ...
    "12_badpick": "Таких костей нет!",
    "13_enemy": "Ваш противник - робот по имени %s",
    "14_robpick": "Робот взял эти кости:",
    "15_00_robturnT": "Робот решил продолжить ход, взяв эти кости",
    "15_01_robrurnF": "Робот решил закончить ход, взяв эти кости",
    "16_won": "ПОЗДРАВЛЯЮ, %s!. ТЫ ПОБЕДИЛ!",
    "17_gmend": "Game was alrady end",
    "18_actchoose": """1 - продолжить ход %n 2 - закончить ход %n
